...
type Props = {
  activeCourse: { title: string; imageSrc: string } //TODO:Replace with db later
  hearts: number
  points: number
  hasActiveSubscription: boolean
}

function UserProgress({ activeCourse, hasActiveSubscription, hearts, points }: Props) {
  return (
      ...
      <Link href='/courses'>
        <Button variant='ghost'>
          <Image
            ...
            alt={activeCourse.title.toLowerCase()}
